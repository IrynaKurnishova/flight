<template>
  <v-navigation-drawer v-model="drawer" color="#425C5A" class="rounded-e-xl">
    <v-sheet color="3D5654" class="pa-4 rounded-te-xl text-center">
      ...
      <div class="mt-4">Iryna Kurnishova</div>
      <span class="mb-6 text-caption">kurnishovaiv@gmail.com</span>
    </v-sheet>
    <v-list>
    ...
    <v-row align="center" class="v-spacer ml-16 mt-4" no-gutters>
      ...
      <v-col cols="4" sm="2" md="1">
        <v-avatar size="36px" color="#B49239">
          +70
        </v-avatar>
      </v-col>
    </v-row>
